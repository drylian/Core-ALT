    ...
    return (
        <div className="flex items-center justify-center h-screen bg-gray-100">
            <div className="bg-white p-8 shadow-lg rounded-2xl">
                <h2 className="text-2xl font-semibold mb-4 text-center">Area de Registro - {!website ? "Core" : website.title}</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4 justify-center  justify-center text-center">
                    ...
                    <div className="justify-center  justify-center text-center">
                        <button
                            type="submit"
