const config = {
    'token': 'MTAwMDk4NjQ5NTcwNTk0ODIxMg.GNJmT_.cGpG-jgAGPM19B9veyZ04Sukx0W0dudfEsyQOM', // Token do bot
    'Debug': false, // Depuração Total do bot. ou não kkk
    ...
    'Start': { // Comandos de Inicialização.
        'Express': { // Start/Status || Status do bot
